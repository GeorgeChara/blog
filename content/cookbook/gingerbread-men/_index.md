...
<pre style="padding: 1em; border-radius: 4px; display: inline-block; margin: 0; color: #000;"><span style="color: #888;">Dry</span>
plain flour       375g
baking powder     12g
ground ginger     6g
ground cinnamon   4g
...
**1.** Cream the butter and brown sugar until light and fluffy, 2 minutes.

<span style="display:block; color:#888; font-size:0.8em; margin-top:-0.5em; border-left: 2px solid #E5DECF; padding-left: 0.6em;">Stand mixer: paddle, medium.</span>

**2.** Beat in the egg and vanilla, then the black treacle on low for 1 minute.

**3.** Add the dry ingredients in 3 to 4 batches, mixing just until it comes together. The dough is soft.

**4.** Shape into a disc, wrap, and chill at least 2 hours.
